        ...
        <>
          <div className="backdrop-blur-md bg-white overflow-y-auto no-scrollbar h-3/4 lg:w-2/3 w-full p-5 rounded-lg text-gray-900 flex flex-col gap-5">
            ...
            <p className="text-sm text-gray-500">
              Welcome to{" "}
              <strong className="font-bold text-rose-600">ReelRapter</strong>.
            ...
            <p className="text-sm text-gray-500">
              ...
              download publicly available videos from supported platforms such
              as TikTok, YouTube, and Facebook. We are not affiliated with,
              endorsed, or sponsored by these platforms.
            </p>
            ...
            <p className="text-sm text-gray-500">
              You agree to use ReelRapter only for lawful purposes. Users are
              solely responsible for ensuring that the content they download is
              not protected by copyright, and that they have the right or
              permission to download and store such material.
            </p>
            ...
            <p className="text-sm text-gray-500">
              ...
              materials without authorization may violate the laws of your
              country and the terms of the source platform. ReelRapter does not
              host or store any user-downloaded content on its servers.
            </p>
            ...
            <p className="text-sm text-gray-500">
              This service is provided <em>"as is"</em> and without any
              warranties, expressed or implied. ReelRapter and its developers
              are not responsible for data loss, misuse, or any damages arising
              from use or inability to use this service.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-500">
              ...
              <li>
                Attempting to modify, reverse-engineer, or exploit the system
              </li>
            </ul>
            ...
            <p className="text-sm text-gray-500">
              ...
              ReelRapter after updates are posted signifies your acceptance of
